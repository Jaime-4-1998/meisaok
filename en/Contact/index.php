        ...
        <div class="meisa_contact">
            <div class="meisa__data">
                ...
                <form class="form__data" id="form">
                    ...
                    <input class="form__control" type="text" name="" id="name" placeholder="Name:">
                    
                    <label class="form__label">Company</label>
                    <input class="form__control" type="text" name="" id="comp" placeholder="Company:">
                    
                    <label class="form__label">City</label>
                    <input class="form__control" type="text" name="" id="ciu" placeholder="City:">
                    
                    <label class="form__label">Country</label>
                    <input class="form__control" type="text" name="" id="pais" placeholder="Country:">
                    
                    <label class="form__label">Mail</label>
                    <input class="form__control" type="email" name="" id="mail" placeholder="corre@example.com:">
                    
                    <label class="form__label">Phone</label>
                    <input class="form__control" type="text" name="" id="tel" placeholder="Phone">
                    
                    <label class="form__label">Message</label>
                    <textarea class="form__control" name="" id="tema" placeholder="Topic to be discussed:" rows="5" cols="12" ></textarea>
