                                    ...
                                    <?php
                                        include '../assets/components/backend/conexion.php';
                                            ...
                                            $sql = "SELECT id_mani,titlemani,contentmani,titlemanieng,contentmanieng
                                              FROM maniobrameisa WHERE id_mani = '$id' "; 
                                            ...
                                            ?>
                                            <h4 clas="card-title text-meisa-red" style="font-style:italic; color: #a20c19 !important;">Contenido en Español</h4>
                                            <h5 class="card-title text-meisa"><?php echo $result -> titlemani; ?></h5>
                                            <p class="card-text text-meisa"><?php echo $result -> contentmani; ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 clas="card-title text-meisa-red" style="font-style:italic; color: #a20c19 !important;">Contenido en Ingles</h4>
                                    <h5 class="card-title text-meisa"><?php echo $result -> titlemanieng; ?></h5>
                                    <p class="card-text text-meisa"><?php echo $result -> contentmanieng; ?></p>
                                </div>
                            </div>
                        </div>
                        <?php }
