                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row"> 
                            <h2 class="text-center" style="disply:block !important; margin:auto !important; margin-bottom:1rem !important;">
                                Edición del Titulo y Contenido de la primer parte de Inicio
                            </h2>
                            <input type="hidden" value="<?php echo $id; ?>" name="idhome">
                                <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-meisa">Editando el Titulo del Primer Encabezado <strong>"Español"</strong></label>
                                            <input type="text" class="form-control" name="titlesp" id="titlesp" placeholder="Minimo 20 palabras">
                                        </div>
                                        <div class="form-group">
                                            <label class="text-meisa">Editando el Contenido del Primer Encabezado <strong>"Español"</strong></label>
                                            <textarea name="editor" id="editor" rows="10" cols="80" placeholder="Crea el contenido de tu blog" requiered></textarea>                                        </div>
                                        </div>
                                <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-meisa">Editando el Titulo del Primer Encabezado <strong>"Ingles"</strong></label>
                                            <input type="text" class="form-control" name="titleng" id="titleng" placeholder="Minimo 20 palabras">
                                        </div>
                                        <div class="form-group">
                                            <label class="text-meisa">Editando el Contenido del Primer Encabezado <strong>"Ingles"</strong></label>
