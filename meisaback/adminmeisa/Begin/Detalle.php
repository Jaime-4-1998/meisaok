                                ...
                                <div class="card-body">
                                    <?php
                                        include '../assets/components/backend/conexion.php';
                                            ...
                                            <h5 class="card-title text-meisa"><?php echo $result -> title_one; ?></h5>
                                            <p class="card-text text-meisa"><?php echo $result -> desc_one; ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-meisa"><?php echo $result -> title_eng; ?></h5>
                                    <p class="card-text text-meisa"><?php echo $result -> desc_oneng; ?></p>
                                </div>
                            </div>
                        </div>
                        <?php }
