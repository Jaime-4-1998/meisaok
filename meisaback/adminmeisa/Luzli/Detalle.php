                                ...
                                <div class="card-body">
                                    <?php
                                        include '../assets/components/backend/conexion.php';
                                            ...
                                            <h5 class="card-title text-meisa"><?php echo $result -> titleluz; ?></h5>
                                            <p class="card-text text-meisa"><?php echo $result -> contentluz; ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-meisa"><?php echo $result -> titleluzeng; ?></h5>
                                    <p class="card-text text-meisa"><?php echo $result -> contentluzeng; ?></p>
                                </div>
                            </div>
                        </div>
                        <?php }
