                                    ...
                                    <?php
                                        include '../assets/components/backend/conexion.php';
                                            ...
                                            $sql = "SELECT id_rent,titlerent,contentrent,titlerenteng,contentrenteng
                                              FROM rentainf WHERE id_rent = '$id' "; 
                                            ...
                                            <h5 class="card-title text-meisa"><?php echo $result -> titlerent; ?></h5>
                                            <p class="card-text text-meisa"><?php echo $result -> contentrent; ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-meisa"><?php echo $result -> titlerenteng; ?></h5>
                                    <p class="card-text text-meisa"><?php echo $result -> contentrenteng; ?></p>
                                </div>
                            </div>
                        </div>
                        <?php }
